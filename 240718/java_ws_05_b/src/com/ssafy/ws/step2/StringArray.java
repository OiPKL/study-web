 ...
 * 
 * 실습 순서
 * 1)String 객체를 3개 저장할 수 있는 배열 생성
 * 2)String 객체를 3개 생성후, 배열에 할당
...
public class StringArray {
	...
	public static void main(String[] args) {
		...
		// Q. String 객체를 3개 저장할 수 있는 배열 strArray를 생성합니다.
