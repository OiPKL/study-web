...
public class ObjectArray {
	...
	public static void main(String[] args) {
		...
		// 1. equals 메소드를 사용한 비교 1 -> ObjectArray 에서는 StringArray 와는 달라짐
		System.out.println(personArray[0].equals(p1) + " / 실행 결과 : true");
		
		// 2. == 연산자를 이용한 비교 1
		System.out.println((personArray[0] == p1) + " / 실행 결과 : true");
		
		// 3. equals 메소드를 사용한 비교 2
		System.out.println(personArray[0].equals(p3) + " / 실행 결과 : false");
		
		// 4. == 연산자를 이용한 비교 2
		System.out.println((personArray[0] == p3) + " / 실행 결과 : false");
