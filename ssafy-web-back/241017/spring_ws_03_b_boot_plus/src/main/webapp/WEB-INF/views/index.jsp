...
<body>
	...
	<h3>이미지 업로드</h3>
	<p>${fileName}</p>
	<a href="./download/${fileName}">이미지 다운로드</a>
	...
	<form method="post" action="./books">
		<label for="id">Book ID:</label> <input type="text" id="id" name="id"
			value="10001" /> <br /> <label for="title">Title:</label> <input
			type="text" id="title" name="title" value="Spring Boot" /> <br /> <label
			for="author">Author:</label> <input type="text" id="author"
			name="author" value="Spring" /> <br />
